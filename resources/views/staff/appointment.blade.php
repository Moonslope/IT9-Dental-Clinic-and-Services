        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-info px-3 py-2 btn-lg d-none d-md-inline-block" data-bs-toggle="modal" data-bs-target="#confirmAppointmentModal">Edit</button>
            ...
            <div class="modal-body mt-3">
               <form action="{{ route('staff.appointments.update', $appointment->id) }}" method="POST">
                  ...
                  <div class="row gap-2 mb-2">
                     <div class="col">
                        <input style="background-color: #d9d9d9" type="text" name="service_name" id="service_name" class="form-control" readonly value="{{ $appointment->service->service_name }}">
                     </div>
