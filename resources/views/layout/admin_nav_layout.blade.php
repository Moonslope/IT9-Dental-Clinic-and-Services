...
<div class="container-fluid vh-100">
   ...
   <div style="min-height: 525px !important;" class="row">
      <div style="background-color: #1e466b !important; max-height: 615px; overflow-y: auto; width: 250px;"
         class="col-2">
         ...
         <div class="pb-2 pt-2 px-2">
            <a class="admin-btn" href="{{ route('admin.appointments') }}"><i class="bi bi-calendar-week fs-5 me-2 ms-3"></i>Appointments</a>
         </div>
