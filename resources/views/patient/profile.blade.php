                  ...
                  <div class="card-body" style="max-height: 230px; overflow-y: auto;">
                     <table class="table">
                        ...
                        <tbody>
                           ...
                           <tr>
                              <td class="p-2">{{ $prescription->treatment->appointment->dentist->user->first_name }} {{
                                       ...
                                       <div id="printArea{{ $prescription->id }}" class="p-4"
                                          ...
                                          <div class="mb-3">
                                             ...
                                             <p><strong>Dentist:</strong> {{
                                                $prescription->treatment->appointment->dentist->user->first_name }} {{
                                                $prescription->treatment->appointment->dentist->user->last_name }}</p>
                                             <p><strong>Name:</strong> {{
                                                $prescription->treatment->appointment->patient->user->first_name }} {{
                                                $prescription->treatment->appointment->patient->user->last_name }}</p>
                                          </div>

                                          <div class="mb-3">
                                             <p><strong>Service:</strong> {{
                                                $prescription->treatment->appointment->service->service_name }}</p>
                                             <p><strong>Medication:</strong> {{ $prescription->medication }}</p>
                                             <p><strong>Instructions:</strong> {{ $prescription->instructions }}</p>
                                             <p><strong>Appointment Date:</strong> {{
                                                $prescription->treatment->appointment->created_at->format('F
                                                j, Y') }}</p>
                                          </div>
                                          ...
                                          <div class="row text-end mt-5">
                                             ...
                                             <div class="pe-5">
                                                <p>Dr. {{
                                                   $prescription->treatment->appointment->dentist->user->first_name }}
                                                   {{ $prescription->treatment->appointment->dentist->user->last_name }}
                                                </p>
                                             </div>
                                          </div>
                                       </div>
                           ...
                           <tr>
                              ...
                              <td class="col-2">
                                 ...
                                 <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div class="modal fade" id="editAppointmentModal-{{ $appointment->id }}"
                                       tabindex="-1" aria-labelledby="editAppointmentModalLabel" aria-hidden="true">
                                       <div class="modal-dialog modal-dialog-centered" style="max-width: 800px">
                                          <div class="modal-content">
                                             ...
                                             <div class="modal-body mt-4">
                                                <form
                                                   action="{{ route('appointments.patient_update', $appointment->id) }}"
                                                   method="POST">
                                                   @csrf
                                                   @method('PUT')
                                                   ...
                                                   <div class="row gap-2 mb-2">
                                                      <div class="col">
                                                         ...
                                                         <select style="background-color: #d9d9d9" name="service_id"
                                                            ...
                                                            <option value="{{ $service->id }}" {{ $appointment->
                                                               service_id
                                                               == $service->id ? 'selected' : '' }}>
